...
function updateProgress() {
  ...
  // Sincronizar letra con el tiempo de reproducción actual (con un pequeño offset de 0.5s para anticipar el cambio y estar perfectamente a tiempo con la voz)
  if (currentParsedLyrics && currentParsedLyrics.length > 0) {
    let activeIdx = 0;
    const lyricOffset = 0.5; // Segundos de adelanto para sincronización
